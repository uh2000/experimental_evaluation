...
decisions (z, h, h_exist, q) for stages 0-1 (months 0-39), fixes them in each
of the 27 scenario models, and re-solves to compute E[obj | EV decisions].
...
NA_MONTHS = set(range(0, 40))   # stages 0-1 (fix n-1 = 2 stages, leave stage 2 free)
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 70)
    print("EEV: applying EV decisions (stages 0-1) to all 27 scenarios")
    print("=" * 70)
