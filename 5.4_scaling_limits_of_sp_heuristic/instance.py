"""
70-cage instance for Section 5.4 — Scaling Limits of the SP Heuristic.
Extends the base 62-cage fleet (Loc1-Loc6) with a synthetic Loc7 (mirror of Loc1,
10 cages) to reach 70 cages total. All other parameters are identical to the
shared models/instance.py.
"""
import numpy as np
import pandas as pd
...
loc_mab = {
    ...
    "Location 7": 4_000_000,
}
regional_mab = 35_000_000 * (7 / 6)
