...
decisions (z, h, h_exist, q) for stages 0-2 (months 0-44), fixes them in each
of the 81 scenario models, and re-solves to compute E[obj | EV decisions].
...
NA_MONTHS = set(range(0, 45))   # stages 0-2
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 70)
    print("EEV: applying EV decisions (stages 0-2) to all 81 scenarios")
    print("=" * 70)
