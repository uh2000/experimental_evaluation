...
# temps_bad_12    = np.array([4.5, 4.5, 4.5, 5.5, 8.5, 11.5, 13.5, 16, 15, 12.5, 9.5, 7])
# temps_normal_12 = np.array([5, 5, 5, 6,  9, 12, 14, 16.5, 15.5, 13, 10, 7.5])
# temps_good_12   = np.array([5.5, 5.5, 5.5, 6.5, 9.5, 12.5, 14.5, 17, 16, 13.5, 10.5, 8])
...
stage_slices = [list(range(0, 10)), list(range(20)),
                list(range(20, T))#, list(range(22, T))
                ]
